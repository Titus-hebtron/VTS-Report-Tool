    ...
    with st.form("incident_form", clear_on_submit=True):
        ...
        if submitted:
            try:
                ...
                st.info("💡 Your data has been preserved. Please check the error and try again.")
                print(f"ERROR: Failed to save incident report: {e}")
                import traceback
                traceback.print_exc()
        ...
        if editable_items_meta and st.button("💾 Save Selected Reports"):
            ...
            for meta in editable_items_meta:
                ...
                try:
                    ...
                    print(f"DEBUG: WhatsApp Report ID returned: {report_id}")
                ...
                if st.button("View Selected Image"):
                    ...
                    try:
                        ...
                        try:
                            ...
                            st.image(normalized_image_bytes, caption=f"{img_name} (normalized) - Incident ID: {selected_id}", width='stretch')
